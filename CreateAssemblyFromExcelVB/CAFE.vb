...
#End Region
    ...
    Private Function CreateAssemblyComponents(subObject As SubObjectCls) As String
        ...
        Try
            If subObject.PartNo.StartsWith("AS-") Then
                ...
                basepartname = "C:\Vault Working Folder\Designs\DT-99999-000.iam"
            ElseIf subObject.PartNo.StartsWith("DT-") Then
                ...
                Else
                    ...
                    basepartname = "C:\Vault Working Folder\Designs\DT-99999-000.ipt"
                End If
    ...
    Private Sub AssignIProperties(ByVal realocc As ComponentOccurrence, ByVal subObject As SubObjectCls)
        Try
            ...
            invProjProperties.ItemByPropId(PropertiesForDesignTrackingPropertiesEnum.kProjectDesignTrackingProperties).Value = "project"
            'Summary iProperties
            ...
            invSummaryiProperties.ItemByPropId(PropertiesForSummaryInformationEnum.kCommentsSummaryInformation).Value = "COMMENT"
        Catch ex As Exception
            MessageBox.Show("Exception was: " + ex.Message + vbCrLf + ex.StackTrace)
        End Try
    End Sub
